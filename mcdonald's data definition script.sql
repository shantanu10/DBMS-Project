...
create table `OWNER`(
    ...
    FOREIGN KEY (`Rest_name`) references Mcstore(`Name`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
insert into `Mcstore`(`Name`,`Location`,`Contact`,`Opening_Closing_Time`,`Details`)
values 
("Mcdonald's","DD City Mall","098935 98343","10:00 AM - 12:00 AM","None");

insert into `OWNER`(`Fname`,`Lname`,`Contact`,`Rest_Name`)
values
("Yash","Vadalia","9999999999","Mcdonald's");
...
values
("Varun","Vashisht","E-121 OBH , lashkar","123211","Provides Non-Veg Stuff."),
("Aneeq","Dholakia","E-15 OBH , lashkar","678668","Provides Sea Food."),
("Sharad","Gupta","E-16 OBH , lashkar","856855","Provides Grocery.");
...
values
("Ashutosh","Dwivedi","7049566293","toshi.cricket@gmail.com"),
("Shantanu","Tripathi","8435564615","shantanu.akt@gmail.com"),
